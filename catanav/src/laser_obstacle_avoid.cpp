...
int main(int argc, char **argv)
{
	...
	nav_waypoints[1].latitude = 42.6780062017; nav_waypoints[1].longitude = -83.1955810567;
	nav_waypoints[0].latitude = 42.6780461517; nav_waypoints[0].longitude = -83.19558017;
	
	//nav_waypoints[0].latitude = 42.6782219317; nav_waypoints[0].longitude = -83.1953864033;
